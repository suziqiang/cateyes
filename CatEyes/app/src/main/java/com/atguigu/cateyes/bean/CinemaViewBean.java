...
public class CinemaViewBean {
    ...
    public static class DataBean {
        @SerializedName("朝阳区")
        private List<BaseBean> chaoyang;
        @SerializedName("海淀区")
        private List<BaseBean> haidian;
        @SerializedName("东城区")
        private List<BaseBean> dongcheng;
        @SerializedName("丰台区")
        private List<BaseBean> fengtai;
        @SerializedName("大兴区")
        private List<BaseBean> daxing;
        @SerializedName("西城区")
        private List<BaseBean> xicheng;
        @SerializedName("通州区")
        private List<BaseBean> tongzhou;
        @SerializedName("昌平区")
        private List<BaseBean> changping;
        @SerializedName("房山区")
        private List<BaseBean> fangshan;
        @SerializedName("顺义区")
        private List<BaseBean> shunyi;
        @SerializedName("门头沟区")
        private List<BaseBean> mentougou;
        @SerializedName("石景山区")
        private List<BaseBean> shijingshan;
        @SerializedName("怀柔区")
        private List<BaseBean> huairou;
        @SerializedName("平谷区")
        private List<BaseBean> pinggu;
        @SerializedName("密云县")
        private List<BaseBean> miyun;
        @SerializedName("延庆县")
        private List<BaseBean> yanqin;
        ...
        public static class Chao extends BaseBean {
        }

        public static class Hai extends BaseBean {
        }

        public static class Dong extends BaseBean {
        }

        public static class Feng extends BaseBean {
        }

        public static class Da extends BaseBean {
        }

        public static class Xi extends BaseBean {
        }

        public static class Tong extends BaseBean {
        }

        public static class Chang extends BaseBean {
        }

        public static class Fang extends BaseBean {
        }

        public static class Shun extends BaseBean {
        }

        public static class Men extends BaseBean {
        }

        public static class Shi extends BaseBean {
        }

        public static class Huai extends BaseBean {
        }

        public static class Ping extends BaseBean {
        }

        public static class Mi extends BaseBean {
        }

        public static class Yan extends BaseBean {
        }
